...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test.FundingRound");
    jdbcTemplate.execute("DELETE FROM test.Stage");
    jdbcTemplate.execute("DELETE FROM test.Document");
    jdbcTemplate.execute("DELETE FROM test.Investor");
    jdbcTemplate.execute("DELETE FROM test.Founder");
    jdbcTemplate.execute("DELETE FROM test.Startup");
     jdbcTemplate.execute("DELETE FROM test.StartupFounders");
     jdbcTemplate.execute("DELETE FROM test.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM test.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM test.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM test.FundingRoundInvestors");
